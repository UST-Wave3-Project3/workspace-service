...
public class WorkspaceService {
	...
	public Workspace updateWorkspace(Workspace editWorkspace) {
	    Optional<Workspace> existingWorkspace = workspaceRepository.findById(editWorkspace.getWorkspaceId());
	    
	    if (existingWorkspace.isPresent()) {
	        Workspace updatedWorkspace = existingWorkspace.get();
	        updatedWorkspace.setWorkspaceAvailable(editWorkspace.isWorkspaceAvailable() || editWorkspace.isWorkspaceAvailable() == updatedWorkspace.isWorkspaceAvailable());
